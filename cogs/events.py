...
Edit 7: Included my paypal(https://paypal.me/kym2k06). Not trying to ask for donations or anything... ''')
            ...
            await ctx.send(f'''⭐Ad 1 Scene 6⭐Hey {ctx.author.name}! I sexually Identify as the "I sexually identify as https://paypal.me/kym2k06" joke. Ever since I was a child, I've dreamed of flippantly dismissing any concepts or discussions regarding gender that don't fit in with what I learned in 8th grade bio. People say to me that this joke hasn't been funny since 2014 and please at least come up with a new one, but I don't care, I'm hilarious. I'm having a plastic surgeon install Ctrl, C, and V keys on my body. From now on I want you guys to call me "epic kek dank meme trannies owned with facts and logic" and respect my right to shit up social media. If you can't accept me you're a memeophobe and need to check your ability-to-critically-think privilege. Thank you for being so understanding.)''')
        

        elif r==7:
            await ctx.send(f'''⭐Ad 1 Scene 7⭐Hey {ctx.author.name}! The Girl you just called fat? She shit herself & lost 15kgs. The Boy you just called stupid? He shit himself. The Girl you just called ugly? She spends hours shitting and farting. The Boy you just tripped? He shit his pants. There`s more to people than you think. Donate to https://paypal.me/kym2k06 if your against bullying.''')

        elif r==8:
            await ctx.send(f'''⭐Ad 1 Scene 8⭐Hey {ctx.author.name}! We just matched on Instagram! Check out my account! OFFICIAL ACCOUNT!
